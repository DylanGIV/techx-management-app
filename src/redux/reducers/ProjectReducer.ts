...
import { PROJECT_CREATE_FAIL, PROJECT_CREATE_STARTED, PROJECT_CREATE_SUCCESS, PROJECT_DELETE_FAILED, PROJECT_DELETE_STARTED, PROJECT_DELETE_SUCCESS, PROJECT_FETCH_FAIL, PROJECT_FETCH_STARTED, PROJECT_FETCH_SUCCESS, PROJECT_SET_CURRENT, PROJECT_UPDATE_FAILED, PROJECT_UPDATE_STARTED, PROJECT_UPDATE_SUCCESS } from '../actions/types';
